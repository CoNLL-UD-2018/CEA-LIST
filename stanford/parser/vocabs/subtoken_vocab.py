...
class SubtokenVocab(TokenVocab):
  ...
  def __call__(self, placeholder=None, moving_params=None):
    ...
    print('===subtoken_vocab.py: START Call ', ' name=', self.name)
    print('===subtoken_vocab.py: embed_keep_prob = ',self.embed_keep_prob)
    ...
    print('===subtoken_vocab.py: END Call ', ' name=', self.name)

...
class PretrainedVocab(BaseVocab):
  ...
  def __call__(self, placeholder=None, moving_params=None):
    ...
    print('===pretrained_vocab.py: START Call ', ' name=', self.name)
    ...
    print('===pretrained_vocab.py: END Call ', ' name=', self.name)
    return matrix
  ...
  def load(self):
    ...
    print("Ouverture de ",filename, " pour charger les embeddings\n")
  ...
  def count(self):
    """"""
    print('error check:',self.token_vocab)

...
class BaseCell(Configurable):
  ...
  def __init__(self, output_size, *args, **kwargs):
    """"""
    print('===base_cell.py: START Creating a BaseCell')
    ...
    print('===base_cell.py: END Creating a BaseCell', ' name=', self.name, ' _input_size=', self._input_size, ' _output_size=', self._output_size)
